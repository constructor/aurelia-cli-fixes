...
const commandParams = [
  { key: 'name', aliases: ['n', 'nme'] },
  { key: 'output', aliases: ['o', 'op'] },
  { key: 'test', aliases: ['t', 'tst'] },
  { key: 'do-it', aliases: ['d', 'di', 'do'] }
];

//au dot-new --name "Site" --output "/NewFolder/Name" --custom 123
module.exports = class {
  ...
  parseItem(args, state, item, key) {
    ...
    //TODO: check why 'hasFlag' is true when 'itemIndex' is -1
    //console.log('Key = ' + key + ' : Has flag = ' + this.options.hasFlag(key) + ' :  ItemIndex = ' + itemIndex);
    ...
    //console.log(valueIndex + ' : ' + args.length + ' : ' + isLastArg);
    ...
    //console.log('key: ' + key + ' : Index: ' + itemIndex + ' : value: ' + state[key]);
